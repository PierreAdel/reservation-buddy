...
RSpec.describe "Hotels API", type: :request do
  describe "GET /hotels" do
    ...
    let!(:hotel1) {FactoryBot.create(:hotel, hotel_name: "Pierre", admin_id: 1 )}
    let!(:hotel2) { FactoryBot.create(:hotel, hotel_name: "Pierre2", admin_id: 1  ) }
  ...
  describe "POST /hotels" do
    ...
    it "Create hotel" do
    expect {
    post "/api/v1/hotels", params: { hotel: { cover_image_url: "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg", hotel_name: "Pierre", description: "the best Pierre Hotel", city: "Pierre city", score: 2, price_per_night: 99.9  }} 
    ...
    describe "DELETE /hotels/:slug" do
      ...
      let!(:hotel) { FactoryBot.create(:hotel, cover_image_url: "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg", hotel_name: "eassazzss", description: "the best Pierre Hotel", city: "Pierre city", score: 2, price_per_night: 99.9, admin_id: 1  )}

      it "Delete a hotel" do
      expect {
      delete "/api/v1/hotels/#{hotel.slug}" 
      }.to change {Hotel.count}.from(1).to(0)
