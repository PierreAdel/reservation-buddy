...
let user = {
 ...
 let xx = Fetch.fetchWithInit(`/api/v1/sessions?email=pierreadelkamel@gmail.com&password=password1`,
    Fetch.RequestInit.make(~method_=Post, ~body=Fetch.BodyInit.make("asd"), ()),)
    ->Js.Promise.then_(Fetch.Response.json, _)
<h1>{"sd"->React.string}</h1>
